      ...
      document.getElementById('richiedi-prelievo').onclick = async () => {
        ...
        area.innerHTML = `
          ...
          <div style="background: #e8f4fd; border: 1px solid #2a5298; border-radius: 8px; padding: 1em; margin-bottom: 1em;">
            ...
            <p>Accumula quanti prelievi vuoi, quando il Bancomat sarà online pagherà il saldo. Se sei online quando è online anche il Bancomat, i tuoi prelievi possono incrementare fino a 100 volte di più!</p>
